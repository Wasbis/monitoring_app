        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row align-items-center">
                    <!-- <div class="col-md-6">
                        <div class="mb-3">
                            <h5 class="card-title">Data Web List<span class="text-muted fw-normal ms-2"></span></h5>
                        </div>
                        <-- test -->
                    </div>
                    <div class="col-md-6">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="inputIp" aria-describedby="NameHelp">
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select id="inputStatus" class="form-select">
                                                        ...
                                                        <option value="Not Active" id="#down">Not Active</option>
                                                        <option value="Down" id="#down">Down</option>
                                                        <option value="Terverifikasi" id="#terverifikasi">Terverifikasi</option>
                                                        <option value="Belum Verifikasi" id="#notverifikasi">Belum Verifikasi</option>
                                                    </select>
                                                </div>
                                            </form>
                                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="text-secondary" >Tampilan Data Web</h4>
...
<?= $this->include('function/functionWeb.php'); ?>
</body>

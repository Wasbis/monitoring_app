            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        ...
                        <span data-key="t-apps"><?= lang('Files.KelolaData'); ?></span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <li>
                            <a href="dataweb">
                                <span data-key="t-calendar"><?= lang('Files.web'); ?></span>
                            </a>
                        </li>
                        <li>
                            <a href="datakelola">
                                <span data-key="t-calendar"><?= lang('Files.Detail'); ?></span>
                            </a>
                        </li>
                        <!-- Kelola Data Detail -->
                    </ul>
                ...
                <li>
                    <a href="dataakun">
                        ...
                        <span data-key="t-horizontal"><?= lang('Files.Akun'); ?></span>
                    </a>
                </li>
                <!-- Kelola Web -->
                <li>
                    <a href="pratinjauweb">
                        ...
                        <span data-key="t-horizontal"><?= lang('Files.pratinjau'); ?></span>
                    </a>
                </li>
                <li>
                ...
                <!-- <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="#" data-key="t-recover-password"><?= lang('Files.Recover_Password') ?></a></li>
                        <li><a href="auth-lock-screen" data-key="t-lock-screen"><?= lang('Files.Lock_Screen') ?> </a></li>
                        <li><a href="#" data-key="t-confirm-mail"><?= lang('Files.Confirm_Mail') ?></a></li>

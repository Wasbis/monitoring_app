                            ...
                            <div class="auth-content my-auto">
                                ...
                                <form class="custom-form mt-4 pt-2" action="/" method="POST">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="member_username" class="form-control" value="" id="inputUsername" placeholder="Enter username">
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group auth-pass-inputgroup">
                                            <input type="password" name="member_password" class="form-control" id="inputPassword" placeholder="Enter password" aria-label="Password" aria-describedby="password-addon">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <div class="testi-contain text-white">
                                                ...
                                                <h4 class="mt-4 fw-medium lh-base text-white">“Aplikasi Monitoring adalah aplikasi berbasis website untuk memonitor website yang berjalan di Server TVRI.”
                                                </h4>
